...
<head>
    ...
    <link rel="shortcut icon" href="images/logoMini.ico">
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/bootstrap-combined.min.css') }}" />
...
<div id="top">
    <div class="container">
        <div class="col-md-6 offer" data-animate="fadeInDown">
            ...
            <a href="/viewpromotion" class="btn btn-success btn-sm" data-animate-hover="shake">New Promotions</a>  <a href="#">Get flat 35% off on orders over $50!</a>
        </div>
