...
<div class="form-group"><div class="panel panel-default, col-md-12 col-md-offset-0 ">
...
<!-- 
    ...
    <div style="color:Brown" ><h3><b> Seasonal  Discounts </b></h3></div>
        @foreach($diplaydisc as $dpds1)
            @if($dpds1->dtype=='Seasonal discount')
                <div class="col-md-6" ><a href="#">
                <img src="{{ $dpds1->imgpath }}" style="height: 200px; width: 180px; alignment: right" class="img-rounded" data-animate-hover="shake"/>
                <div style="color:#009933"><b>{{ $dpds1->ipersentage }}% OFF</b></div>
                <div style="color:#009933"><b>Price : <del style="color:red">LKR {{ $dpds1->price }}</del> LKR {{ $dpds1->iprice }}</b></div>
                <div style="color:#009933 "><b>Up To : {{ $dpds1->edate }}</b></div><br/>
            </a></div>
        ...
        <br/>
        <div style="color:Brown"><b><h3> Festival Discount </h3></b></div><br/>
        @foreach($diplaydisc as $dpds1)
            @if($dpds1->dtype=='Festival discount')
                <div ><a href="#">
                <img src="{{ $dpds1->imgpath }}" style="height: 200px; width: 180px; alignment: right" class="img-rounded" data-animate-hover="shake"/>
        ...
        <div style="color:Brown"><b><h3> New Year Discount </h3></b></div><br/>
        @foreach($diplaydisc as $dpds1)
            @if($dpds1->dtype=='New year discount')
                <div ><a href="#">
                <img src="{{ $dpds1->imgpath }}" style="height: 200px; width: 180px; alignment: right" class="img-rounded" data-animate-hover="shake"/>
                <div style="color:#009933"><b>{{ $dpds1->ipersentage }}% OFF</b></div>
                <div style="color:#009933"><b>Price : <del style="color:red">LKR {{ $dpds1->price }}</del> LKR {{ $dpds1->iprice }}</b></div>
                <div style="color:#009933 "><b>Up To : {{ $dpds1->edate }}</b></div>
                </a></div>
            @endif
        @endforeach
        <br/>

        <div style="color:Brown"><b><h3> Year End Discount </h3></b></div><br/>
        @foreach($diplaydisc as $dpds1)
            @if($dpds1->dtype=='Year end discount')
            ...
            @endif
        @endforeach
                <div style="color:Brown"><b><h3> Other Discount </h3></b></div>
        @foreach($diplaydisc as $dpds1)
            @if($dpds1->dtype=='Other types')
                <div  class="col-sm-6"><a href="#">
                    <img src="{{ $dpds1->imgpath }}" style="height: 200px; width: 180px; alignment: right" class="img-rounded" data-animate-hover="shake"/>
        ...
        @endforeach
           ...
           <!--  <div  class="col-sm-4"><a href="#">
                <img src="{{ $dpds1->imgpath }}" style="height: 200px; width: 180px; alignment: right" class="img-rounded" data-animate-hover="shake"/>
                <div style="color:#029443 "><b>{{ $dpds1->dtype }}</b></div>
                <div style="color:#009933"><b>{{ $dpds1->ipersentage }}% OFF</b></div>
                <div style="color:#009933"><b>Price : <del style="color:red">LKR {{ $dpds1->price }}</del> LKR {{ $dpds1->iprice }}</b></div>
                <div style="color:#009933 "><b>Up To : {{ $dpds1->edate }}</b></div><br/>
            </a></div> -->
            ...
            <!-- @if($dpds1->dtype=='Seasonal discount')
                <p style="color:Yellow">Seasonal Discounts
            <div  class="col-sm-4"><a href="#">
                <img src="{{ $dpds1->imgpath }}" style="height: 200px; width: 180px; alignment: right" class="img-rounded" data-animate-hover="shake"/>
                <div style="color:#009933"><b>{{ $dpds1->ipersentage }}% OFF</b></div>
                <div style="color:#009933"><b>Price : <del style="color:red">LKR {{ $dpds1->price }}</del> LKR {{ $dpds1->iprice }}</b></div>
